...
export function SiteHeader() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-border bg-background/90 shadow-sm backdrop-blur-xl">
          ...
          {user ? (
            <>
              <button
                ...
                className="flex items-center gap-2 rounded-full border border-border bg-card py-1 pl-1 pr-3 text-sm text-foreground transition hover:bg-accent"
              >
              ...
              {profileOpen && (
                <div className="absolute right-0 top-12 z-50 w-56 rounded-xl border border-border bg-popover p-2 text-popover-foreground shadow-xl">
                  ...
                  <a
                    href="/dashboard"
                    className="mt-1 flex items-center gap-2 rounded-lg px-3 py-2 text-sm transition-colors hover:bg-accent"
                  >
            ...
            <>
              <a
                href="/auth"
                className="rounded-lg px-4 py-2 text-sm font-medium text-muted-foreground transition hover:bg-accent hover:text-accent-foreground"
              >
                Sign in
              </a>
              ...
              <>
                ...
                <div className="mt-2 border-t border-border pt-2">
                  <button
                    type="button"
                    onClick={signOut}
                    className="flex w-full items-center justify-center gap-2 rounded-lg border border-red-200 px-3 py-2.5 text-sm font-medium text-red-600 transition-colors hover:bg-red-50 dark:border-red-900/50 dark:text-red-400 dark:hover:bg-red-950/30"
                  >
                    <LogOut className="h-4 w-4" />
                    Sign out
                  </button>
            ...
            {!user && (
              <div className="mt-2 border-t border-border pt-3">
                <a
                  href="/auth"
                  onClick={() => setMobileOpen(false)}
                  className="block w-full rounded-lg bg-gradient-brand px-3 py-2.5 text-center text-sm font-medium text-brand-foreground transition hover:opacity-90"
                >
                  Sign in / Get started
                </a>
              </div>
